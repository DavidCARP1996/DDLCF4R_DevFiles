...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "This mod may contain graphical violence, blood, and posibility a bit of gore."
        "It also may contain sexual themes, partial nudity, strong language, use of drugs and alcohol, and black humor."
        "If you can't stand with all those things, please don't play this mod, and go to play some fantasy fairy childish mod.{w} Just kidding."
        "This story has a new perspective of the mod's author about the original DDLC story, and it's non canon to the original story of DDLC or any other future games by Team Salvato."
        ...
        if persistent.finished_ddlc == "postcredits_loop":
            menu:
                "This mod detects that you already have completed the game. By playing [config.name], you consent to your exposure of usual highly disturbing content, within additional content such as {i}glitchy, flashy images and disturbing,distorting soundtracks.{/i}"
                "I agree.":
                    pass
        else:
            menu:
                "By playing [config.name] you agree that you have completed DDLC and accept any spoilers contained within, and you consent to your exposure of highly disturbing content, such as {i}glitchy, flashy images and disturbing, distorting soundtracks.{/i}"
                "I agree.":
                    pass
        scene tos2
        with Dissolve(1.5)
