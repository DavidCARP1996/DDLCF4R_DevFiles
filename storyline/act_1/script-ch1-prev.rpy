...
label ch1_schooltime:
    ...
    $ roof_check = False
    jump ch1_schooltime1_loop

label ch1_schooltime1_loop:
    while sayori_found == False:
        if ch1_activities_s == 0:
            $ menutext = "Where should I go first?"
        else:
            $ menutext = "Where should I go next?"
        menu:
            ...
            "Sayori's classroom" if not s_classroom_check:
                ...
                $ ch1_activities_s += 1
                call ch1_schooltime_loop_sclassroom
                pass
            ...
            "Give up!":
                ...
                pass
        pass
    jump ch1_schooltime2

    label ch1_schooltime_loop_sclassroom:
    ...
    label ch1_schooltime_loop_mcclassroom:
        scene bg class_day
        with wipeleft_scene
    ...
    label ch1_schooltime_loop_backyard:
    ...
    label ch1_schooltime_loop_entrance:
