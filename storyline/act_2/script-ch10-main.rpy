...
label ch10_sayorisaved_main:
    ...
    if breakfast == True:
        ...
        "I give her the cookie I take in the kitchen."
        s 4m "Ahhh..."
    ...
    "Oh, boy... She's so..." 
    "HOT!!!"
    "Wait! What could think Sayori about if I'm just gonna act like a pervert?"
    ...
    m 1 "So, you were at the soccer club years ago, right?"
    m "It's a shame that you should left it by that injury..."
    ...
    "She looks like me, except that I prefer video games, football, anime or any internet things."
...
###########################################
########## NO-SAYORI SAVED ROUTE ##########
###########################################

label ch10_nonesaved_main:
    ...
    "Mornings are usually the worst, a bullshit, being surrounded by couples and friend groups walking to school together."
    "Meanwhile, I've always fucking walked to the fucking school alone as fuck."
