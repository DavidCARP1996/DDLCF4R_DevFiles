label monika_exclusive_1:
    ...
    m 4q "Ehehe, sorry~"
    m 4i "Wait!"
    m 1j "Actually, I'm not sorry at all!"
    m "It's your fault for sleeping like that!"
    m "This isn't the napping club!"
    mc "Does our school have a napping club...?"
    m 1h "You're staying up late again, aren't you?"
    m "Now that you're in a club, you're gonna have less time for anime, you know!"
    m "You'll need to get used to it!"
    mc "Don't say that so loud...!"
    "I glance over my shoulder to see if Monika overheard."
    m 1g "It's true, though..."
    mc "Yeah..."
    mc "I know, I know."
    mc "You're always looking out for me, Sayori."
    m 4q "Ehehe~"
    m "It's what I do best!"
    mc "...That's a problem!"
    mc "What about you?"
    ...
    mc "I knew it..."
    m 5a "C'monnnn!"
    m "At least give me the benefit of the doubt..."
    mc "I can't even do that."
    mc "Look, Sayori, it's written all over you."
    m 1b "Eh...?"
    "Monika glances around at herself."
