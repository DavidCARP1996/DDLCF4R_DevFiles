...
## center.
define gui.text_xpos = 270
define gui.text_ypos = 50

## The maximum width of dialogue text, in pixels.
define gui.text_width = 745
...
define gui.quick_button_text_idle_color = "#fcc"
...
define gui.choice_button_text_idle_color = "#f33" #"#000"
define gui.choice_button_text_hover_color = "#fff" #"#fa9"
...
#### INVENTORY EXCLUSIVE (put inventory to be easy for search)
## The number of columns and rows in the grid of item slots.

define gui.item_slot_cols = 2
define gui.item_slot_rows = 2
