...
#        yalign 0.95
        ...
        if store.hkb_button.talk_enabled:
            textbutton _("Inventory") action Function(button_one)
        else:
            frame:
                ypadding 5
                xsize 120
        ...
        if store.hkb_button.music_enabled:
            textbutton _("Equip") action Function(button_two)
        else:
            frame:
                ypadding 5
                xsize 120
        ...
        if store.hkb_button.play_enabled:
            textbutton _("Food bag") action Function(button_thr)
        else:
            frame:
                ypadding 5
                xsize 120
